...
There are many ways to go about programming, called Programming Paradigms. Some
languages are specialize to a specific Programming Paradigm. Lisp was designed
as a general purpose language, supporting programming in any Programming
Paradigm. The right paradigm can allow you to solve a challenging problem with
ease and elegance. Being fluent in multiple paradigms makes you a magical
programmer.
