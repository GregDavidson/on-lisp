...
*=eval= maps /S-Exprs/ to /Values/*

*Atoms*
- *Symbols:* =eval= returns value in the environment /or signals an error if none/
- *All other atoms:* Simply evaluate to themselves

*Evaluable /Lists/ are called /Forms/*

*All Elements of Regular Forms are evaluated - recursively if nested* 
...
*Special Forms are handled as a special case by =eval=*
