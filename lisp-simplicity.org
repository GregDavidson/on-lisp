...
- =(if _test_ _if-true_ _if-false_)= :: evaluates _if-true_ or _if-false_
      - _test_: an S-Expr which evaluates to a /Boolean Value/
      ...
      - thus =(if _test_ _if-true_ _if-false_)=
            - evaluates _if-true_ if _test_ is _true_, i.e. not =#f=
            - evaluates _if-false_ if _test_ is _false_, i.e. is =#f=
